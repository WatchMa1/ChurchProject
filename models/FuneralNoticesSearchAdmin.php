...
/**
 * FuneralNoticesSearchAdmin represents the model behind the search form of `app\models\FuneralNotices`.
 */
class FuneralNoticesSearchAdmin extends FuneralNotices
{
    /**
     * {@inheritdoc}
     */
