...
/* @var $model app\models\OfferingAndTitheSearch */
...
<div id="accordionsearch">
    ...
    <div class="card">
        <div class="" id="headingTwo" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false"
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionsearch">
            <div class="card-body">
    ...
    <div class="mb-2 text-center">
        ...
        if (validateDate($date_of_receipt_from)) {
            echo 'FROM <u>'.date('d M, Y',strtotime($date_of_receipt_from)).'</u>';
        } else {
            echo '';
        }
        if (validateDate($date_of_receipt_to)) {
