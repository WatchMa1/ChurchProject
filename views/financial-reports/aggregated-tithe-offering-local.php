...
$this->title = 'Local Funds - Aggregated Income Summary - '.$months.' '.$year;
...
<div class="local-funds-aggregated-summary">
    ...
    <div class="card-header">
            ...
            <div class="dropdown-menu">
                <?php 
                    ...
                    foreach ($fundyearData as $row) {
                        ...
                        if ($curYearIteration) {
                            echo  '<div>'.Html::a($curYearIteration, ['local-funds-aggregated-summary','year' => $curYearIteration], ['class' => 'mx-2 my-1 btn btn-outline-dark btn-sm']).'</div>' ;
                        }
        ...
        <div class="btn-group">
            ...
            for ($i=1; $i <= count($longMonthNames); $i++) { 
                ...
                if ($curMonth) {
                echo  '<div>'.Html::a($curMonth, ['local-funds-aggregated-summary','year' => $year, 'm'=>$i], ['class' => 'mx-2 my-1 btn btn'.$month_class.'-primary btn-sm']).'</div>' ;
                }
    ...
    <?php //echo $this->render('_search2', ['model' => $searchModel, 'year'=>$year, 'url' => 'local-funds-aggregated-summary']); ?>
    <div class="">
