                                    ...
                                    <div class="p-5">
                                        <div class="text-center">
                                            ...
                                            <h3 class="h4 text-gray-900 mb-4"
                                                style="font-family:Courier New, monospace;">University Church
                                                Congregation Management System</h3>
                                        </div>
                                        <?= $content ?>
                                        <hr>
                                        <div class="text-center">
                                            <?= Html::a('Register', ['user/guest-create'], ['class' => 'btn btn-primary']) ?>
                                            <br>
                                            <a class="small" href="member/forgotpassword">Forgot Password?</a>
                                        </div>
                                        <div class="text-center">
                                            <a class="small" href="interest/create">I am a visitor</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
