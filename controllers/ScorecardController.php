...
class ScorecardController extends Controller
{
    ...
    public function actionIndex2()
    {
        ...
        if (User::userIsAllowedTo('Manage Department') || $department->name == 'SPMEC') {
            ...
            $initiatives = Initiative::find()->where(['department_id' => $department->id])->all();
            ...
            Yii::$app->session->setFlash('error', 'The score card is still blank. Create initiatives.');
            return $this->redirect(['/initiatives']);
        }
    ...
    public function actionIndex()
    {
        ...
        if (User::userIsAllowedTo('Manage Department')) {
            ...
            $initiatives = Initiative::find()->where(['department_id' => $department->id])->asArray()->all();
