...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2022 at 08:48 PM
...
(1, 28, '', NULL, '', 1666187508, 1666187508);
...
(7, 1, 38, 2022, 28, 1665048767, 1665063714),
...
INSERT INTO `fund_items` (`id`, `item_name`, `description`, `fund_category`, `year`, `budget`, `created_at`, `updated_at`) VALUES
(1, 'Local LCB', '', 20, 2022, '283465.52', NULL, NULL),
(2, 'Tithe', '', 23, 2022, '4567654.89', NULL, NULL),
(3, 'Advent Youth', '', 20, 2022, '4565.00', 1666488987, 1666535222),
(4, 'Dorcas', '', 21, 2022, '345687.69', 1666550794, 1666550794);
...
(22, 2, 1, NULL, 2023, 38, 38, 1664901918, 38, 1665123319, 9);
...
(38, 'muyunda', '', 'sililo', 'sililosililo82@gmail.com', '$2y$13$t.a64rjQPMU/tv9Wrtdyru1ldL.oBrYe4MYdX79hFoHv3umJVL9qa', 'G-06YSgwKpHmk06-zjyyyhbmcx8gW5-1', 1664901714, 1665063714, 1, 2, 9);
...
INSERT INTO `weekly_schedule` (`id`, `day`, `theme`, `elder_one`, `elder_two`, `clerk_one`, `clerk_two`, `deacon_one`, `deacon_two`, `cares_concern`, `announcements`, `sabbath_school`, `main_service`, `afternoon_service`, `personal_ministries`, `health_message`, `other`) VALUES
(2, '2022-10-08', 'the theme to be announced', 28, NULL, NULL, NULL, NULL, NULL, '', '', '<p>pfo:kgo</p>', '', '', '', '', '');
...
--
-- Constraints for table `baptism_interest`
--
ALTER TABLE `baptism_interest`
  ADD CONSTRAINT `baptism_interest_ibfk_1` FOREIGN KEY (`user`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `baptism_interest_ibfk_2` FOREIGN KEY (`recieved_by`) REFERENCES `user` (`id`);

--
-- Constraints for table `child_dedication`
--
ALTER TABLE `child_dedication`
  ADD CONSTRAINT `child_dedication_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `church_contacts`
--
ALTER TABLE `church_contacts`
  ADD CONSTRAINT `church_contacts_ibfk_1` FOREIGN KEY (`position_id`) REFERENCES `church_positions` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `church_officers`
--
ALTER TABLE `church_officers`
  ADD CONSTRAINT `church_officers_ibfk_1` FOREIGN KEY (`added_by`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `church_officers_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `church_officers_ibfk_4` FOREIGN KEY (`position_id`) REFERENCES `church_positions` (`id`);

--
-- Constraints for table `church_positions`
--
ALTER TABLE `church_positions`
  ADD CONSTRAINT `church_positions_ibfk_1` FOREIGN KEY (`added_by`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `church_positions_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`);
...
--
-- Constraints for table `departmental_expense_items`
--
ALTER TABLE `departmental_expense_items`
  ADD CONSTRAINT `departmental_expense_items_ibfk_1` FOREIGN KEY (`fund_item`) REFERENCES `fund_items` (`id`);

--
-- Constraints for table `incomes_and_expenses`
--
ALTER TABLE `incomes_and_expenses`
  ADD CONSTRAINT `incomes_and_expenses_ibfk_1` FOREIGN KEY (`added_by`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `incomes_and_expenses_ibfk_2` FOREIGN KEY (`fund_item`) REFERENCES `fund_items` (`id`);
...
--
-- Constraints for table `offering_and_tithe`
--
ALTER TABLE `offering_and_tithe`
  ADD CONSTRAINT `offering_and_tithe_ibfk_2` FOREIGN KEY (`added_by`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `offering_and_tithe_ibfk_3` FOREIGN KEY (`updated_by`) REFERENCES `user` (`id`);

--
-- Constraints for table `offering_and_tithe_receipts`
--
ALTER TABLE `offering_and_tithe_receipts`
  ADD CONSTRAINT `offering_and_tithe_receipts_ibfk_1` FOREIGN KEY (`fund_item`) REFERENCES `fund_items` (`id`),
  ADD CONSTRAINT `offering_and_tithe_receipts_ibfk_2` FOREIGN KEY (`added_by`) REFERENCES `user` (`id`);

--
-- Constraints for table `payment_request`
--
ALTER TABLE `payment_request`
  ADD CONSTRAINT `payment_request_ibfk_1` FOREIGN KEY (`department`) REFERENCES `department` (`id`) ON DELETE NO ACTION,
  ADD CONSTRAINT `payment_request_ibfk_2` FOREIGN KEY (`requested_by`) REFERENCES `user` (`id`) ON DELETE NO ACTION;

--
-- Constraints for table `tithe_offering`
--
ALTER TABLE `tithe_offering`
  ADD CONSTRAINT `tithe_offering_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
...
--
-- Constraints for table `wedding_notices`
--
ALTER TABLE `wedding_notices`
  ADD CONSTRAINT `wedding_notices_ibfk_1` FOREIGN KEY (`added_by`) REFERENCES `user` (`id`);

--
-- Constraints for table `weekly_schedule`
--
ALTER TABLE `weekly_schedule`
  ADD CONSTRAINT `weekly_schedule_ibfk_1` FOREIGN KEY (`clerk_one`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `weekly_schedule_ibfk_2` FOREIGN KEY (`clerk_two`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `weekly_schedule_ibfk_3` FOREIGN KEY (`deacon_one`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `weekly_schedule_ibfk_4` FOREIGN KEY (`deacon_two`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `weekly_schedule_ibfk_5` FOREIGN KEY (`elder_one`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `weekly_schedule_ibfk_6` FOREIGN KEY (`elder_two`) REFERENCES `user` (`id`);
COMMIT;
